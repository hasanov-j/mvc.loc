...
<head>
    ...
    <!-- shopping cart style -->
    <link href="../public/css/shopping-cart.css" rel="stylesheet"/>
...
<!-- book section -->
<section class="book_section layout_padding" style="background-color: #222831;">

    <?php
        if(array_key_exists('errors',$_SESSION)){
            $errors = \App\Components\Session::get('errors');
