...
(function (global, factory) {
    ...
    var ClassName$4 = {
        ...
        DROPRIGHT: "dropright",
        DROPLEFT: "dropleft",
        MENURIGHT: "dropdown-dishes-right",
        MENULEFT: "dropdown-dishes-left",
        POSITION_STATIC: "position-static",
    };
    var Selector$4 = {
        DATA_TOGGLE: '[data-toggle="dropdown"]',
        FORM_CHILD: ".dropdown form",
        MENU: ".dropdown-dishes",
        NAVBAR_NAV: ".navbar-nav",
        VISIBLE_ITEMS:
            ".dropdown-dishes .dropdown-item:not(.disabled):not(:disabled)",
    };
    var AttachmentMap = {
        TOP: "top-start",
        TOPEND: "top-end",
        ...
        (function () {
            ...
            _proto.toggle = function toggle() {
                ...
                if (!this._inNavbar) {
                    ...
                    // to allow the dishes to "escape" the scroll parent's boundaries
            ...
            Dropdown._dataApiKeydownHandler = function _dataApiKeydownHandler(
                ...
                //    - If trigger inside the dishes => not a dropdown command
                if (
                    /input|textarea/i.test(event.target.tagName)
    ...
    var Selector$9 = {
        ...
        DROPDOWN_TOGGLE: ".dropdown-toggle",
        DROPDOWN_ACTIVE_CHILD: "> .dropdown-dishes .active",
        /**
         * ------------------------------------------------------------------------
         * Class Definition
         * ------------------------------------------------------------------------
